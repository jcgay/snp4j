...
import static fr.jcgay.snp4j.assertion.SnpAssertions.assertThat;
...
public class SnpSocketImplTest {
    ...
    public void should_send_message_error_response() throws Exception {
        ...
        assertThat(result)
                ...
                .hasHost("ie10win7")
                .hasDaemon("Snarl 3.0")
                .hasError(new fr.jcgay.snp4j.impl.response.Error(Status.ARG_MISSING, "ArgMissing", "A required argument was missing"));
    }
    ...
    public void should_send_message_error_response_as_specified_by_the_documentation() throws Exception {
        ...
        assertThat(result)
                ...
                .hasHost("conerstone")
                .hasDaemon("Snarl 2.4")
                .hasError(new fr.jcgay.snp4j.impl.response.Error(Status.AUTH_FAILURE, "AuthenticationFailure", "Digest Mismatch"));
    }
